...
export const PPI_DEFINITIONS: Record<PpiId, PpiDefinition> = {
  ...
  [PpiId.AD_START_CALIBRATION]: {
    ...
    lengths: { rq: START_CALIBRATION_PARAM_T_SIZE_BYTES, re: 1, push: CALIBRATION_FEEDBACK_T_SIZE_BYTES },
  },
  ...
  [PpiId.AD_CAP_DETECTION_CONFIG]: {
    id: PpiId.AD_CAP_DETECTION_CONFIG,
    name: "PPI_AD_CAP_DETECTION_CONFIG",
    lengths: { rq: 0, re: CAP_DETECTION_STATUS_T_SIZE_BYTES, push: CAP_DETECTION_CFG_T_SIZE_BYTES },
  },
  [PpiId.AD_CAP_DETECTION_SAMPLE_RATE]: {
    id: PpiId.AD_CAP_DETECTION_SAMPLE_RATE,
    name: "PPI_AD_CAP_DETECTION_SAMPLE_RATE",
    lengths: { push: 2 },
  },
  [PpiId.AD_CAP_DETECTION_STATUS]: {
    id: PpiId.AD_CAP_DETECTION_STATUS,
    name: "PPI_AD_CAP_DETECTION_STATUS",
    lengths: { push: CAP_DETECTION_STATUS_T_SIZE_BYTES },
  },
};
