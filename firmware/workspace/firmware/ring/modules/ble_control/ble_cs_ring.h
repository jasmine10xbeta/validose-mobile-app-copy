...
#ifndef BLE_CS_RING_H_
#define BLE_CS_RING_H_
/***********************************************************************************************************************
 * Includes
 **********************************************************************************************************************/
// Standard includes
...
#define CONTROL_SERVICE_UUID_BASE                                                                                      \
   {                                                                                                                   \
      0x07, 0x59, 0x91, 0x1A, 0xF6, 0x75, 0x79, 0xB5, 0x12, 0x4B, 0xF3, 0xDB, 0xB1, 0xD8                               \
   }

#define CONTROL_SERVICE_UUID 0x1500 // Custom Service UUID
// Input to device:
#define UUID_DEVICE_COMAMNDS 0x1501

// Output to App - None for now
...
typedef enum
{
   ...
   BLE_CS_EVT_DEVICE_COMMANDS_UPDATED,
} BLE_CS_EVT;
