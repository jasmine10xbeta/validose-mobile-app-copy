/**
  ...
  * @brief   ST25DV register header file
  ******************************************************************************
  * @attention
  *
...
/* Exported types ------------------------------------------------------------*/
/**
 * @brief  ST25DV Write register function typedef definition.
 */
typedef int32_t (*ST25DV_WriteReg_Func)(const void *const, const uint16_t, const uint8_t *const, const uint16_t);

/**
 * @brief  ST25DV Read register function typedef definition.
 */
typedef int32_t (*ST25DV_ReadReg_Func) (const void *const, const uint16_t, uint8_t *const, const uint16_t);

/**
 * @brief  ST25DV context structure.
 */
typedef struct
{
...
int32_t ST25DV_GetGPO_RFWRITE(const ST25DV_Ctx_t *const ctx, uint8_t *const value);
