...
static int32_t WriteRegWrap(const void *const Handle, const uint16_t Reg, const uint8_t *const pData, const uint16_t Length);

int32_t ST25DV_Init(ST25DV_Object_t *const pObj);
int32_t ST25DV_ReadID(const ST25DV_Object_t *const pObj, uint8_t *const pICRef);
int32_t ST25DV_ReadICRev(const ST25DV_Object_t *const pObj, uint8_t *const pICRev);
int32_t ST25DV_IsDeviceReady(const ST25DV_Object_t *const pObj, const uint32_t Trials);
int32_t ST25DV_GetGPOStatus(const ST25DV_Object_t *const pObj, uint16_t *const pGPOStatus);
int32_t ST25DV_ConfigureGPO(const ST25DV_Object_t* pObj, const uint16_t ITConf);
int32_t ST25DV_ReadITPulse(const ST25DV_Object_t *const pObj, ST25DV_PULSE_DURATION *const pITtime);
int32_t ST25DV_WriteITPulse(const ST25DV_Object_t *const pObj, const ST25DV_PULSE_DURATION ITtime);
int32_t ST25DV_ReadData(const ST25DV_Object_t *const pObj, uint8_t *const pData, const uint16_t TarAddr, const uint16_t NbByte);
int32_t ST25DV_WriteData(const ST25DV_Object_t *const pObj, const uint8_t *const pData, const uint16_t TarAddr, const uint16_t NbByte);
int32_t ST25DV_ReadRegister(const ST25DV_Object_t *const pObj, uint8_t *const pData, const uint16_t TarAddr, const uint16_t NbByte);
int32_t ST25DV_WriteRegister(const ST25DV_Object_t *const pObj, const uint8_t *const pData, const uint16_t TarAddr, const uint16_t NbByte);
int32_t ST25DV_ReadUID(const ST25DV_Object_t *const pObj, ST25DV_UID *const pUid);
int32_t ST25DV_ReadDSFID(const ST25DV_Object_t *const pObj, uint8_t *const pDsfid);
int32_t ST25DV_ReadDsfidRFProtection(const ST25DV_Object_t *const pObj, ST25DV_LOCK_STATUS *const pLockDsfid);
int32_t ST25DV_ReadAFI(const ST25DV_Object_t *const pObj, uint8_t *const pAfi);
int32_t ST25DV_ReadAfiRFProtection(const ST25DV_Object_t *const pObj, ST25DV_LOCK_STATUS *const pLockAfi);
int32_t ST25DV_ReadI2CProtectZone(const ST25DV_Object_t *const pObj, ST25DV_I2C_PROT_ZONE *const pProtZone);
int32_t ST25DV_WriteI2CProtectZonex(const ST25DV_Object_t *const pObj, const ST25DV_PROTECTION_ZONE Zone, const ST25DV_PROTECTION_CONF ReadWriteProtection);
int32_t ST25DV_ReadLockCCFile(const ST25DV_Object_t *const pObj, ST25DV_LOCK_CCFILE *const pLockCCFile);
int32_t ST25DV_WriteLockCCFile(const ST25DV_Object_t *const pObj, const ST25DV_CCFILE_BLOCK NbBlockCCFile, const ST25DV_LOCK_STATUS LockCCFile);
int32_t ST25DV_ReadLockCFG(const ST25DV_Object_t *const pObj, ST25DV_LOCK_STATUS *const pLockCfg);
int32_t ST25DV_WriteLockCFG(const ST25DV_Object_t *const pObj, const ST25DV_LOCK_STATUS LockCfg);
int32_t ST25DV_PresentI2CPassword(const ST25DV_Object_t *const pObj, const ST25DV_PASSWD PassWord);
int32_t ST25DV_WriteI2CPassword(const ST25DV_Object_t *const pObj, const ST25DV_PASSWD PassWord);
int32_t ST25DV_ReadRFZxSS(const ST25DV_Object_t *const pObj, const ST25DV_PROTECTION_ZONE Zone, ST25DV_RF_PROT_ZONE *const pRfprotZone);
int32_t ST25DV_WriteRFZxSS(const ST25DV_Object_t *const pObj, const ST25DV_PROTECTION_ZONE Zone, const ST25DV_RF_PROT_ZONE RfProtZone);
int32_t ST25DV_ReadEndZonex(const ST25DV_Object_t *const pObj, const ST25DV_END_ZONE EndZone, uint8_t *pEndZ);
int32_t ST25DV_WriteEndZonex(const ST25DV_Object_t *const pObj, const ST25DV_END_ZONE EndZone, const uint8_t EndZ);
int32_t ST25DV_InitEndZone(const ST25DV_Object_t *const pObj);
int32_t ST25DV_CreateUserZone(const ST25DV_Object_t *const pObj, uint16_t Zone1Length, uint16_t Zone2Length, uint16_t Zone3Length, uint16_t Zone4Length);
int32_t ST25DV_ReadMemSize(const ST25DV_Object_t *const pObj, ST25DV_MEM_SIZE *const pSizeInfo);
int32_t ST25DV_ReadEHMode(const ST25DV_Object_t *const pObj, ST25DV_EH_MODE_STATUS *const pEH_mode);
int32_t ST25DV_WriteEHMode(const ST25DV_Object_t *const pObj, const ST25DV_EH_MODE_STATUS EH_mode);
int32_t ST25DV_ReadRFMngt(const ST25DV_Object_t *const pObj, ST25DV_RF_MNGT *const pRF_Mngt);
int32_t ST25DV_WriteRFMngt(const ST25DV_Object_t *const pObj, const uint8_t Rfmngt);
int32_t ST25DV_GetRFDisable(const ST25DV_Object_t *const pObj, ST25DV_EN_STATUS *const pRFDisable);
int32_t ST25DV_SetRFDisable(const ST25DV_Object_t *const pObj);
int32_t ST25DV_ResetRFDisable(const ST25DV_Object_t *const pObj);
int32_t ST25DV_GetRFSleep(const ST25DV_Object_t *const pObj, ST25DV_EN_STATUS *const pRFSleep);
int32_t ST25DV_SetRFSleep(const ST25DV_Object_t *const pObj);
int32_t ST25DV_ResetRFSleep(const ST25DV_Object_t *const pObj);
int32_t ST25DV_ReadMBMode(const ST25DV_Object_t *const pObj, ST25DV_EN_STATUS *const pMB_mode);
int32_t ST25DV_WriteMBMode(const ST25DV_Object_t *const pObj, const ST25DV_EN_STATUS MB_mode);
int32_t ST25DV_ReadMBWDG(const ST25DV_Object_t *const pObj, uint8_t *const pWdgDelay);
int32_t ST25DV_WriteMBWDG(const ST25DV_Object_t *const pObj, const uint8_t WdgDelay);
int32_t ST25DV_ReadMailboxData(const ST25DV_Object_t *const pObj, uint8_t *const pData, const uint16_t TarAddr, const uint16_t NbByte);
int32_t ST25DV_WriteMailboxData(const ST25DV_Object_t *const pObj, const uint8_t *const pData, const uint16_t NbByte);
int32_t ST25DV_ReadMailboxRegister(const ST25DV_Object_t *const pObj, uint8_t *const pData, const uint16_t TarAddr, const uint16_t NbByte);
int32_t ST25DV_WriteMailboxRegister(const ST25DV_Object_t *const pObj, const uint8_t *const pData, const uint16_t TarAddr, const uint16_t NbByte);
int32_t ST25DV_ReadI2CSecuritySession_Dyn(const ST25DV_Object_t *const pObj, ST25DV_I2CSSO_STATUS *const pSession);
int32_t ST25DV_ReadITSTStatus_Dyn(const ST25DV_Object_t *const pObj, uint8_t *const pITStatus);
int32_t ST25DV_ReadGPO_Dyn(const ST25DV_Object_t *const pObj, uint8_t *GPOConfig);
int32_t ST25DV_GetGPO_en_Dyn(const ST25DV_Object_t *const pObj, ST25DV_EN_STATUS *const pGPO_en);
int32_t ST25DV_SetGPO_en_Dyn(const ST25DV_Object_t *const pObj);
int32_t ST25DV_ResetGPO_en_Dyn(const ST25DV_Object_t *const pObj);
int32_t ST25DV_ReadEHCtrl_Dyn(const ST25DV_Object_t *const pObj, ST25DV_EH_CTRL *const pEH_CTRL);
int32_t ST25DV_GetEHENMode_Dyn(const ST25DV_Object_t *const pObj, ST25DV_EN_STATUS *const pEH_Val);
int32_t ST25DV_SetEHENMode_Dyn(const ST25DV_Object_t *const pObj);
int32_t ST25DV_ResetEHENMode_Dyn(const ST25DV_Object_t *const pObj);
int32_t ST25DV_GetEHON_Dyn(const ST25DV_Object_t *const pObj, ST25DV_EN_STATUS *const pEHON);
int32_t ST25DV_GetRFField_Dyn(const ST25DV_Object_t *const pObj, ST25DV_FIELD_STATUS *const pRF_Field);
int32_t ST25DV_GetVCC_Dyn(const ST25DV_Object_t *const pObj, ST25DV_VCC_STATUS *const pVCC);
int32_t ST25DV_ReadRFMngt_Dyn(const ST25DV_Object_t *const pObj, ST25DV_RF_MNGT *const pRF_Mngt);
int32_t ST25DV_WriteRFMngt_Dyn(const ST25DV_Object_t *const pObj, const uint8_t RF_Mngt);
int32_t ST25DV_GetRFDisable_Dyn(const ST25DV_Object_t *const pObj, ST25DV_EN_STATUS *const pRFDisable);
int32_t ST25DV_SetRFDisable_Dyn(const ST25DV_Object_t *const pObj);
int32_t ST25DV_ResetRFDisable_Dyn(const ST25DV_Object_t *const pObj);
int32_t ST25DV_GetRFSleep_Dyn(const ST25DV_Object_t *const pObj, ST25DV_EN_STATUS *const pRFSleep);
int32_t ST25DV_SetRFSleep_Dyn(const ST25DV_Object_t *const pObj);
int32_t ST25DV_ResetRFSleep_Dyn(const ST25DV_Object_t *const pObj);
int32_t ST25DV_ReadMBCtrl_Dyn(const ST25DV_Object_t *const pObj, ST25DV_MB_CTRL_DYN_STATUS *const pCtrlStatus);
int32_t ST25DV_GetMBEN_Dyn(const ST25DV_Object_t *const pObj, ST25DV_EN_STATUS *const pMBEN);
int32_t ST25DV_SetMBEN_Dyn(const ST25DV_Object_t *const pObj);
int32_t ST25DV_ResetMBEN_Dyn(const ST25DV_Object_t *const pObj);
int32_t ST25DV_ReadMBLength_Dyn(const ST25DV_Object_t *const pObj, uint8_t *const pMBLength);
...
/**
  ...
  */
int32_t ST25DV_RegisterBusIO(ST25DV_Object_t *const pObj, const ST25DV_IO_t *const pIO)
{
...
/**
  ...
  * @param[out] pICRef Pointer on an uint8_t used to return the ST25DV ID.
  * @return int32_t enum status.
  */
int32_t ST25DV_ReadID(const ST25DV_Object_t *const pObj, uint8_t *const pICRef)
{
...
/**
  ...
  * @param[in] pObj pointer to the device structure object.
  * @param[out] pICRev Pointer on the uint8_t used to return the ST25DV IC Revision number.
  * @return int32_t enum status.
  */
int32_t ST25DV_ReadICRev(const ST25DV_Object_t *const pObj, uint8_t *const pICRev)
{
...
/**
  ...
  * @param[in] pObj pointer to the device structure object.
  * @param[out] pUid Pointer used to return the ST25DV UID value.
  * @return int32_t enum status.
  */
int32_t ST25DV_ReadUID(const ST25DV_Object_t *const pObj, ST25DV_UID *const pUid)
{
...
/**
  ...
  * @param[in] pObj pointer to the device structure object.
  * @param[out] pDsfid Pointer used to return the ST25DV DSFID value.
  * @return int32_t enum status.
  */
int32_t ST25DV_ReadDSFID(const ST25DV_Object_t *const pObj, uint8_t *const pDsfid)
{
...
/**
  ...
  * @param[in] pObj pointer to the device structure object.
  * @param[out] pLockDsfid Pointer on a ST25DV_LOCK_STATUS used to return the DSFID lock state.
  * @return int32_t enum status.
  */
int32_t ST25DV_ReadDsfidRFProtection(const ST25DV_Object_t *const pObj, ST25DV_LOCK_STATUS *const pLockDsfid)
{
...
/**
  ...
  * @param[in] pObj pointer to the device structure object.
  * @param[out] pAfi Pointer used to return the ST25DV AFI value.
  * @return int32_t enum status.
  */
int32_t ST25DV_ReadAFI(const ST25DV_Object_t *const pObj, uint8_t *const pAfi)
{
...
/**
  ...
  * @param[in] pObj pointer to the device structure object.
  * @param[out] pLockAfi Pointer on a ST25DV_LOCK_STATUS used to return the ASFID lock state.
  * @return int32_t enum status.
  */
int32_t ST25DV_ReadAfiRFProtection(const ST25DV_Object_t *const pObj, ST25DV_LOCK_STATUS *const pLockAfi)
{
...
/**
  ...
  * @param[in] pObj pointer to the device structure object.
  * @param[out] pProtZone Pointer on a ST25DV_I2C_PROT_ZONE structure used to return the Protected Area state.
  * @return int32_t enum status.
  */
int32_t ST25DV_ReadI2CProtectZone(const ST25DV_Object_t *const pObj, ST25DV_I2C_PROT_ZONE *const pProtZone)
{
...
/**
  ...
  * @details  Needs the I2C Password presentation to be effective.
  * @param[in] pObj pointer to the device structure object.
  * @param[in] Zone                ST25DV_PROTECTION_ZONE value coresponding to the area to protect.
  * @param[in] ReadWriteProtection ST25DV_PROTECTION_CONF value corresponding to the protection to be set.
  * @return   int32_t enum status.
  */
int32_t ST25DV_WriteI2CProtectZonex(const ST25DV_Object_t *const pObj, const ST25DV_PROTECTION_ZONE Zone, const ST25DV_PROTECTION_CONF ReadWriteProtection)
{
...
/**
  ...
  * @param[in] pObj pointer to the device structure object.
  * @param[out] pLockCCFile Pointer on a ST25DV_LOCK_CCFILE value corresponding to the lock state of the CCFile.
  * @return int32_t enum status.
  */
int32_t ST25DV_ReadLockCCFile(const ST25DV_Object_t *const pObj, ST25DV_LOCK_CCFILE *const pLockCCFile)
{
...
/**
  ...
  * @details  Needs the I2C Password presentation to be effective.
  * @param[in] pObj pointer to the device structure object.
  * @param[in] NbBlockCCFile ST25DV_CCFILE_BLOCK value corresponding to the number of blocks to be locked.
  * @param[in] LockCCFile ST25DV_LOCK_CCFILE value corresponding to the lock state to apply on the CCFile.
  * @return int32_t enum status.
  */
int32_t ST25DV_WriteLockCCFile(const ST25DV_Object_t *const pObj, const ST25DV_CCFILE_BLOCK NbBlockCCFile, const ST25DV_LOCK_STATUS LockCCFile)
{
...
/**
  ...
  * @param[in] pObj pointer to the device structure object.
  * @param[out] pLockCfg Pointer on a ST25DV_LOCK_STATUS value corresponding to the Cfg registers lock state.
  * @return int32_t enum status.
  */
int32_t ST25DV_ReadLockCFG(const ST25DV_Object_t *const pObj, ST25DV_LOCK_STATUS *const pLockCfg)
{
...
/**
  ...
  * @details  Needs the I2C Password presentation to be effective.
  * @param[in] pObj pointer to the device structure object.
  * @param[in] LockCfg ST25DV_LOCK_STATUS value corresponding to the lock state to be written.
  * @return int32_t enum status.
  */
int32_t ST25DV_WriteLockCFG(const ST25DV_Object_t *const pObj, const ST25DV_LOCK_STATUS LockCfg)
{
...
/**
  ...
  * @param[in] pObj pointer to the device structure object.
  * @param[in] Zone ST25DV_PROTECTION_ZONE value coresponding to the protected area.
  * @param[out] pRfprotZone Pointer on a ST25DV_RF_PROT_ZONE value corresponding to the area protection state.
  * @return int32_t enum status.
  */
int32_t ST25DV_ReadRFZxSS(const ST25DV_Object_t *const pObj, const ST25DV_PROTECTION_ZONE Zone, ST25DV_RF_PROT_ZONE *const pRfprotZone)
{
...
/**
  ...
  * @details  Needs the I2C Password presentation to be effective.
  * @param[in] pObj pointer to the device structure object.
  * @param[in] Zone ST25DV_PROTECTION_ZONE value corresponding to the area on which to set the RF protection.
  * @param[in] RfProtZone  Pointer on a ST25DV_RF_PROT_ZONE value defininf the protection to be set on the area.
  * @return int32_t enum status.
  */
int32_t ST25DV_WriteRFZxSS(const ST25DV_Object_t *const pObj, const ST25DV_PROTECTION_ZONE Zone, const ST25DV_RF_PROT_ZONE RfProtZone)
{
...
/**
  ...
  * @param[in] pObj pointer to the device structure object.
  * @param[in] EndZone ST25DV_END_ZONE value corresponding to an area end address.
...
/**
  ...
  * @details  Needs the I2C Password presentation to be effective.
  * @note     The ST25DV answers a NACK when setting the EndZone2 & EndZone3 to same value than repectively 
  *           EndZone1 & EndZone2.\n These NACKs are ok.
  * @param[in] pObj pointer to the device structure object.
  * @param[in] EndZone ST25DV_END_ZONE value corresponding to an area.
...
int32_t ST25DV_WriteEndZonex(const ST25DV_Object_t *const pObj, const ST25DV_END_ZONE EndZone, const uint8_t EndZ)
{
  ...
  {
    case ST25DV_ZONE_END1:
      ST25DV_GetENDA1(&(pObj->Ctx), &existingValue);
      if (existingValue != EndZ)
        status = ST25DV_SetENDA1(&(pObj->Ctx),&EndZ);
      else
        status = NFCTAG_OK;
      break;
    case ST25DV_ZONE_END2:
      ST25DV_GetENDA2(&(pObj->Ctx), &existingValue);
      if (existingValue != EndZ)
      ...
      break;
    case ST25DV_ZONE_END3:
      ST25DV_GetENDA3(&(pObj->Ctx), &existingValue);
      if (existingValue != EndZ)
...
/**
  ...
  * @details  Needs the I2C Password presentation to be effective..
  *           The ST25DV answers a NACK when setting the EndZone2 & EndZone3 to same value than repectively 
...
int32_t ST25DV_InitEndZone(const ST25DV_Object_t *const pObj)
{
  ...
  ST25DV_WriteEndZonex(pObj, ST25DV_ZONE_END1, 0x00);
  ST25DV_WriteEndZonex(pObj, ST25DV_ZONE_END2, 0x01);
...
int32_t ST25DV_CreateUserZone(const ST25DV_Object_t *const pObj, uint16_t Zone1Length, uint16_t Zone2Length, uint16_t Zone3Length, uint16_t Zone4Length)
{
  ...
  if((Zone1Length % 32) != 0)
  {
    Zone1Length_tmp = Zone1Length - (Zone1Length % 32);
  }
  
  if((Zone2Length % 32) != 0)
  {
    Zone2Length_tmp = Zone2Length - (Zone2Length % 32);
  }
  
  if((Zone3Length % 32) != 0)
  {
    Zone3Length_tmp = Zone3Length - (Zone3Length % 32);
  }
  ...
  EndVal = (uint8_t)((Zone1Length_tmp / 32) - 1);
  ret = ST25DV_WriteEndZonex(pObj, ST25DV_ZONE_END1, EndVal);
  if((ret != NFCTAG_OK) && (ret != NFCTAG_NACK))
  {
    return ret;
  ...
  EndVal = (uint8_t)(((Zone1Length_tmp + Zone2Length_tmp) / 32) - 1);
  ret = ST25DV_WriteEndZonex(pObj, ST25DV_ZONE_END2, EndVal);
  if((ret != NFCTAG_OK) && (ret != NFCTAG_NACK))
  {
    return ret;
  ...
  EndVal = (uint8_t)(((Zone1Length_tmp + Zone2Length_tmp + Zone3Length_tmp) / 32) - 1);
  ret = ST25DV_WriteEndZonex(pObj, ST25DV_ZONE_END3, EndVal);
  if((ret != NFCTAG_OK) && (ret != NFCTAG_NACK))
  {
    return ret;
...
/**
  ...
  * @param[in] pObj pointer to the device structure object.
  * @param[out] pSizeInfo Pointer on a ST25DV_MEM_SIZE structure used to return the Memory size information.
  * @return int32_t enum status.
  */
int32_t ST25DV_ReadMemSize(const ST25DV_Object_t *const pObj, ST25DV_MEM_SIZE *const pSizeInfo)
{
...
/**
  ...
  * @param[in] pObj pointer to the device structure object.
  * @param[out] pEH_mode Pointer on a ST25DV_EH_MODE_STATUS value corresponding to the Energy Harvesting state.
  * @return int32_t enum status.
  */
int32_t ST25DV_ReadEHMode(const ST25DV_Object_t *const pObj, ST25DV_EH_MODE_STATUS *const pEH_mode)
{
...
/**
  ...
  * @details  Needs the I2C Password presentation to be effective.
  * @param[in] pObj pointer to the device structure object.
  * @param[in] EH_mode ST25DV_EH_MODE_STATUS value for the Energy harvesting mode to be set.
  * @return int32_t enum status.
  */
int32_t ST25DV_WriteEHMode(const ST25DV_Object_t *const pObj, const ST25DV_EH_MODE_STATUS EH_mode)
{
...
/**
  ...
  * @param[in] pObj pointer to the device structure object.
  * @param[out] pRF_Mngt Pointer on a ST25DV_RF_MNGT structure used to return the RF Management configuration.
  * @return int32_t enum status.
  */
int32_t ST25DV_ReadRFMngt(const ST25DV_Object_t *const pObj, ST25DV_RF_MNGT *const pRF_Mngt)
{
...
/**
  ...
  * @param[in] pObj pointer to the device structure object.
  * @param[out] pRFDisable Pointer on a ST25DV_EN_STATUS value corresponding to the RF Disable status.
  * @return int32_t enum status.
  */
int32_t ST25DV_GetRFDisable(const ST25DV_Object_t *const pObj, ST25DV_EN_STATUS *const pRFDisable)
{
...
/**
  ...
  * @param[in] pObj pointer to the device structure object.
  * @param[out] pRFSleep Pointer on a ST25DV_EN_STATUS value corresponding to the RF Sleep status.
  * @return int32_t enum status.
  */
int32_t ST25DV_GetRFSleep(const ST25DV_Object_t *const pObj, ST25DV_EN_STATUS *const pRFSleep)
{
...
/**
  ...
  * @param[in] pObj pointer to the device structure object.
  * @param[out] pMB_mode Pointer on a ST25DV_EH_MODE_STATUS value used to return the Mailbox mode.
  * @return int32_t enum status.
  */
int32_t ST25DV_ReadMBMode(const ST25DV_Object_t *const pObj, ST25DV_EN_STATUS *const pMB_mode)
{
...
/**
  ...
  * @details  Needs the I2C Password presentation to be effective.
  * @param[in] pObj pointer to the device structure object.
  * @param[out] MB_mode ST25DV_EN_STATUS value corresponding to the Mailbox mode to be set.
  * @return int32_t enum status.
  */
int32_t ST25DV_WriteMBMode(const ST25DV_Object_t *const pObj, const ST25DV_EN_STATUS MB_mode)
{
...
/**
  ...
  * @return int32_t enum status.
  */
int32_t ST25DV_ReadMailboxData(const ST25DV_Object_t *const pObj, uint8_t *const pData, const uint16_t Offset, const uint16_t NbByte)
{
...
/**
  ...
  * @param[in] pObj pointer to the device structure object.
  * @param[out] pSession Pointer on a ST25DV_I2CSSO_STATUS value used to return the session status.
  * @return int32_t enum status.
  */
int32_t ST25DV_ReadI2CSecuritySession_Dyn(const ST25DV_Object_t *const pObj, ST25DV_I2CSSO_STATUS *const pSession)
{
...
/**
  ...
  * @param[in] pObj pointer to the device structure object.
  * @param[out] pGPO ST25DV_GPO pointer of the dynamic GPO configuration to store.
...
/**
  ...
  * @param[in] pObj pointer to the device structure object.
  * @param[out] pGPO_en ST25DV_EN_STATUS pointer of the GPO enable status to store.
  * @retval NFCTAG enum status
  */
int32_t ST25DV_GetGPO_en_Dyn(const ST25DV_Object_t *const pObj, ST25DV_EN_STATUS *const pGPO_en)
{
...
/**
  ...
  * @param[in] pObj pointer to the device structure object.
  * @param[out] pEH_CTRL : ST25DV_EH_CTRL pointer of the dynamic EH Ctrl configuration to store.
  * @retval NFCTAG enum status
  */
int32_t ST25DV_ReadEHCtrl_Dyn(const ST25DV_Object_t *const pObj, ST25DV_EH_CTRL *const pEH_CTRL)
{
...
/**
  ...
  * @param[in] pObj pointer to the device structure object.
  * @param[out] pEH_Val Pointer on a ST25DV_EN_STATUS value used to return the Energy Harvesting dynamic status.
  * @return int32_t enum status.
  */
int32_t ST25DV_GetEHENMode_Dyn(const ST25DV_Object_t *const pObj, ST25DV_EN_STATUS *const pEH_Val)
{
...
/**
  ...
  * @param[in] pObj pointer to the device structure object.
  * @param[out] pEHON Pointer on a ST25DV_EN_STATUS value used to return the EHON status.
  * @return int32_t enum status.
  */
int32_t ST25DV_GetEHON_Dyn(const ST25DV_Object_t *const pObj, ST25DV_EN_STATUS *const pEHON)
{
...
/**
  ...
  * @param[in] pObj pointer to the device structure object.
  * @param[out] pRF_Field Pointer on a ST25DV_FIELD_STATUS value used to return the field presence.
  * @return int32_t enum status.
  */
int32_t ST25DV_GetRFField_Dyn(const ST25DV_Object_t *const pObj, ST25DV_FIELD_STATUS *const pRF_Field)
{
...
/**
  ...
  * @param[in] pObj pointer to the device structure object.
  * @param[out] pVCC ST25DV_VCC_STATUS pointer of the VCC status to store.
  * @retval NFCTAG enum status.
  */
int32_t ST25DV_GetVCC_Dyn(const ST25DV_Object_t *const pObj, ST25DV_VCC_STATUS *const pVCC)
{
...
/**
  ...
  * @param[in] pObj pointer to the device structure object.
  * @param[out] pRF_Mngt ST25DV_RF_MNGT pointer of the dynamic RF Management configuration to store
  * @retval NFCTAG enum status
  */
int32_t ST25DV_ReadRFMngt_Dyn(const ST25DV_Object_t *const pObj, ST25DV_RF_MNGT *const pRF_Mngt)
{
...
/**
  ...
  * @param[in] pObj pointer to the device structure object.
  * @param[out] pRFDisable Pointer on a ST25DV_EN_STATUS value used to return the RF Disable state.
  * @return int32_t enum status.
  */
int32_t ST25DV_GetRFDisable_Dyn(const ST25DV_Object_t *const pObj, ST25DV_EN_STATUS *const pRFDisable)
{
...
/**
  ...
  * @param[in] pObj pointer to the device structure object.
  * @param[out] pRFSleep Pointer on a ST25DV_EN_STATUS values used to return the RF Sleep state.
  * @return int32_t enum status.
  */
int32_t ST25DV_GetRFSleep_Dyn(const ST25DV_Object_t *const pObj, ST25DV_EN_STATUS *const pRFSleep)
{
...
/**
  ...
  * @param[in] pObj pointer to the device structure object.
  * @param[out] pCtrlStatus Pointer on a ST25DV_MB_CTRL_DYN_STATUS structure used to return
...
/**
  ...
  * @param[in] pObj pointer to the device structure object.
  * @param[out] pMBEN pointer on ST25DV_EN_STATUS values used to return the Mailbox enable state.
  * @return int32_t enum status.
  */
int32_t ST25DV_GetMBEN_Dyn(const ST25DV_Object_t *const pObj, ST25DV_EN_STATUS *const pMBEN)
{
...
/**
  * @brief Reads register on the ST25DV device.
...
/**
  * @brief  Writes register on the ST25DV device.
  * @param[in] handle pointer to the context device structure object.
  ...
  * @return int32_t enum status.
  */
static int32_t WriteRegWrap(const void *const handle, const uint16_t Reg, const uint8_t *const pData, const uint16_t len)
{
  int32_t ret;
  ST25DV_Object_t *pObj = (ST25DV_Object_t *)handle;
