...
#define MBEDTLS_PLATFORM_STD_MEM_HDR                                                                                   \
   <stdlib.h> /**< Header to include if MBEDTLS_PLATFORM_NO_STD_FUNCTIONS is defined. Don't define if no header is     \
                 needed. */
...
#define MBEDTLS_SSL_CIPHERSUITES                                                                                       \
   MBEDTLS_TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA, MBEDTLS_TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA,                             \
      MBEDTLS_TLS_PSK_WITH_AES_256_CBC_SHA, MBEDTLS_TLS_PSK_WITH_AES_128_CBC_SHA
